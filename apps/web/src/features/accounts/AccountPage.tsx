  ...
  if (!auth && !loading && mode !== 'account') return <section className="auth-page">
    <div className="auth-card">
      ...
      <form onSubmit={submit} className="account-form">
        ...
        <label>Пароль<input name="password" type="password" autoComplete={registering ? 'new-password' : 'current-password'} required minLength={registering ? 8 : 1} maxLength={128} />
          {registering && <small>Минимум 8 символов. Можно использовать длинную фразу.</small>}</label>
