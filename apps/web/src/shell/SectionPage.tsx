...
const details: Record<string, { lead: string; cards: [string, string][] }> = {
  ...
  '/help': { lead: 'Короткие подсказки по основным разделам ИЗО АСА.', cards: [['Чат', 'Начните с обычного запроса и выберите инструмент, если нужен результат другого типа.'], ['Изображение', 'Используйте отдельную студию для уже работающей серверной генерации изображений.'], ['Галерея', 'Ваши сохранённые результаты находятся в личной галерее.']] },
}
