...
Dev network сейчас намеренно изолирован. Реальные внешние AI API не заработают просто от добавления ключа: этап API-001 включает явную безопасную исходящую сеть и тест egress для worker. Не открывать PostgreSQL/S3 в интернет ради AI.
